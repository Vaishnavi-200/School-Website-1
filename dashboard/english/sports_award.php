...
<head>
    <title>VivaTech- Sports Awards</title>
    <?php 
...
<body>
    ...
    <div class="page-header nevy-bg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    <h2 class="page-title">Sports Awards</h2>       
					<p class="page-description yellow-color">"Elevate, Compete, Achieve: Unleashing the Spirit of Champions on Every Field."</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div>
            ...
            <div class="row tb default-margin-bottom yellow-theme">
                <div class="col-md-9 col-sm-8 block-title-area tb-cell">
                    <div class="heading-content style-one border">
                        ...
                        <h2 class="title">Our Students Sports Achivements</h2>
