...
<head>
<title>VivaTech- Selection Committee</title>
    <?php 
...
<body>
	...
	<div class="page-header nevy-bg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    <h2 class="page-title">Selection Committee</h2>
                    <p class="page-description yellow-color">""Empowering Minds, Inspiring Futures: Where committee Illuminate the Path to Knowledge.""</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div>
            ...
            <div class="row tb default-margin-bottom yellow-theme">
                <div class="col-md-9 block-title-area tb-cell">
                    <div class="heading-content style-one border">
                        <h3 class="subtitle">Excellent Team Of </h3>
                        <h2 class="title">Selection Committee</h2>
            ...
            <div class="driver-carousel slider-style-two owl-carousel" data-item="[4,2,2,1]">
                <div class="item">
                    <div class="driver-content vehicle-content theme-yellow">
                        ...
                        <div class="vehicle-bottom-content">
                           <h2 class="driver-name vehicle-title"><a href="#">Mrs Kavya</a></h2>
                ...
                <div class="item">
                    <div class="driver-content vehicle-content theme-yellow">
                        ...
                        <div class="vehicle-bottom-content">
                           <h2 class="driver-name vehicle-title"><a href="#">Mr Sagar</a></h2>
                ...
                <div class="item">
                    <div class="driver-content vehicle-content theme-yellow">
                        ...
                        <div class="vehicle-bottom-content">
                           <h2 class="driver-name vehicle-title"><a href="#">Mr Smith</a></h2>
                ...
                <div class="item">
                    <div class="driver-content vehicle-content theme-yellow">
                        ...
                        <div class="vehicle-bottom-content">
                           <h2 class="driver-name vehicle-title"><a href="#">Miss Soumya</a></h2>
