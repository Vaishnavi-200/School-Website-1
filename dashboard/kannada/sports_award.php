...
<head>
    <title>ವಿವಾ ತಂತ್ರಜ್ಞಾನ-- ಕ್ರೀಡಾ ಪ್ರಶಸ್ತಿಗಳು</title>
    <?php 
...
<body>
    ...
    <div class="page-header nevy-bg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    <h2 class="page-title">ಕ್ರೀಡಾ ಪ್ರಶಸ್ತಿಗಳು</h2>       
					<p class="page-description yellow-color">"ಎಲಿವೇಟ್, ಪೈಪೋಟಿ, ಸಾಧಿಸಿ: ಪ್ರತಿ ಕ್ಷೇತ್ರದಲ್ಲೂ ಚಾಂಪಿಯನ್ಸ್ ಸ್ಪಿರಿಟ್ ಅನ್ನು ಸಡಿಲಿಸುವುದು."</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div>
            ...
            <div class="row tb default-margin-bottom yellow-theme">
                <div class="col-md-9 col-sm-8 block-title-area tb-cell">
                    <div class="heading-content style-one border">
                        ...
                        <h2 class="title">ನಮ್ಮ ವಿದ್ಯಾರ್ಥಿಗಳ ಕ್ರೀಡಾ ಸಾಧನೆಗಳು</h2>
                ...
                <div class="item row">
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/sp1.jpg" alt="car-item" />
                                </a>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/sp3.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->  
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/sp4.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->  
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/sp5.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 --> 
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/sp6.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->   
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/sp7.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 --> 
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/sp8.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->  
