...
<head>
    <title>ವಿವಾಟೆಕ್- ಎನ್ಸಿಸಿ / ಸ್ಕೌಟ್ಸ್ ಮತ್ತು ಗೈಡ್ಸ್</title>
    <?php 
...
<body>
    ...
    <div class="page-header nevy-bg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    <h2 class="page-title">ಎನ್ಸಿಸಿ / ಸ್ಕೌಟ್ಸ್ ಮತ್ತು ಗೈಡ್ಸ್</h2>       
            ...
            <div class="row tb default-margin-bottom yellow-theme">
                <div class="col-md-9 col-sm-8 block-title-area tb-cell">
                    <div class="heading-content style-one border">
                        ...
                        <h2 class="title">ಸ್ಕೌಟ್ಸ್ ಮತ್ತು ಗೈಡ್ಸ್‌ನಲ್ಲಿ ನಮ್ಮ ವಿದ್ಯಾರ್ಥಿಗಳ ಪಾಲ್ಗೊಳ್ಳುವಿಕೆ</h2>
                ...
                <div class="item row">
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/ncc1.jpg" alt="car-item" />
                                </a>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/ncc2.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->  
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/ncc3.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->  
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/ncc4.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 --> 
