...
<head>
    <title>ವಿವಾ ತಂತ್ರಜ್ಞಾನ- ರಾಷ್ಟ್ರೀಯ ಪ್ರಶಸ್ತಿಗಳು </title>
    <?php 
...
<body>
    ...
    <div class="page-header nevy-bg">
        <div class="container">
            <div class="row">
                <div class="col-md-12">                
                    <h2 class="page-title">ರಾಷ್ಟ್ರೀಯ ಪ್ರಶಸ್ತಿಗಳು</h2>       
					<p class="page-description yellow-color">"ವೈವಿಧ್ಯತೆಯನ್ನು ಅನಾವರಣಗೊಳಿಸುವುದು, ಏಕತೆಯನ್ನು ಆಚರಿಸುವುದು: ಅಲ್ಲಿ ಸಂಸ್ಕೃತಿಗಳು ಒಮ್ಮುಖವಾಗುತ್ತವೆ ಮತ್ತು ಅರಳುತ್ತವೆ!"</p>        
                </div><!-- /.col-md-12 -->
            </div><!-- /.row-->
        </div><!-- /.container-fluid -->           
    </div>
            ...
            <div class="row tb default-margin-bottom yellow-theme">
                <div class="col-md-9 col-sm-8 block-title-area tb-cell">
                    <div class="heading-content style-one border">
                        <h3 class="subtitle">ಕ್ಷಣಗಳನ್ನು ಸೆರೆಹಿಡಿಯುವುದು, ನೆನಪುಗಳನ್ನು ಸೃಷ್ಟಿಸುವುದು</h3>
                        <h2 class="title">ನಮ್ಮ ವಿದ್ಯಾರ್ಥಿಗಳ ರಾಷ್ಟ್ರೀಯ ಪ್ರಶಸ್ತಿಗಳು</h2>
                ...
                <div class="col-md-3 col-sm-4 hidden-xs block-navigation-area tb-cell">
                    <div class="pull-right">                    
                        ...
                        <div class="view-all-item">
                            <a href="#" class="view-all-btn">ಎಲ್ಲಾ ವೀಕ್ಷಿಸಿ</a>
                        </div><!-- /.view-all-item -->
                    </div><!-- /.pull-right -->
                </div><!-- /.col-md-2 -->
            </div><!-- /.row --> 
                ...
                <div class="item row">
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/aw1.jpg" alt="car-item" />
                                </a>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/aw2.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->  
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/aw3.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->  
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/aw4.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 --> 
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/aw5.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->   
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/aw6.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 --> 
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/aw7.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->  
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="vehicle-content theme-yellow">
                            <div class="vehicle-thumbnail">
                                <a href="#">
                                    <img src="images/aw8.jpg" alt="car-item" />
                                </a>
                            </div><!-- /.vehicle-thumbnail -->
                        </div><!-- /.vehicle-content -->
                    </div><!-- /.col-md-3 -->
