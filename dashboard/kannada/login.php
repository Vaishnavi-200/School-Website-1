...
<head>
    <title>ವಿವಾ ತಂತ್ರಜ್ಞಾನ- ಲಾಗಿನ್</title>
    <?php 
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="contact-us-content-right">
                        ...
                        <form action="#">
                            <h3 class="from-title">ಲಾಗಿನ್</h3>
                            <i class="fa fa-paper-plane" aria-hidden="true"></i>
                            <div class="input-content clearfix">
                                
                                <div class="row">
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="ಬಳಕೆದಾರರ ಗುರುತು*" class="form-control">
                                    </div><!-- /.col-sm-6 -->
                                    <div class="col-sm-6">
                                        <input type="text" placeholder="ಗುಪ್ತಪದ*" class="form-control">
                                    </div><!-- /.col-sm-6 -->
                                    
                                   
                                </div><!-- /.row -->
                                <div class="subimt-button clearfix">
                                    <input type="submit" value="ಸಲ್ಲಿಸು" class="submit yellow-button">
                                </div><!-- /.subimt -->
                            </div><!-- /.input-content -->
                        </form>
